...
"""autogenerated by genpy from manipulation_msgs/Object.msg. Do not edit."""
import sys
...
class Object(genpy.Message):
  _md5sum = "bf23ef95064f4210d1bed46aedd97d9f"
  _type = "manipulation_msgs/Object"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """manipulation_msgs/Grasp[] grasping_poses
string type
string id
...
float64 w
"""
  __slots__ = ['grasping_poses','type','id','pose']
  _slot_types = ['manipulation_msgs/Grasp[]','string','string','geometry_msgs/Pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.grasping_poses is None:
        self.grasping_poses = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.grasping_poses)
      buff.write(_struct_I.pack(length))
      for val1 in self.grasping_poses:
        _v1 = val1.pose
        _v2 = _v1.position
        _x = _v2
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.tool_name = str[start:end].decode('utf-8')
        else:
          val1.tool_name = str[start:end]
        self.grasping_poses.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
