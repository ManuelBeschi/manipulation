function [data, info] = addObjectsResponse
%AddObjects gives an empty data for manipulation_msgs/AddObjectsResponse
...
info.MessageType = 'manipulation_msgs/AddObjectsResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
