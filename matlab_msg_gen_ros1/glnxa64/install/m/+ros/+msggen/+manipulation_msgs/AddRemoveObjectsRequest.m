...
classdef AddRemoveObjectsRequest < ros.Message
    %AddRemoveObjectsRequest MATLAB implementation of manipulation_msgs/AddRemoveObjectsRequest
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.
    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'manipulation_msgs/AddRemoveObjectsRequest' % The ROS message type
    end
    properties (Constant, Hidden)
        MD5Checksum = 'c5a2c66d971abb45d9c05fd28ac08124' % The MD5 Checksum of the message definition
        ...
        PropertyMessageTypes = { 'ros.msggen.manipulation_msgs.Object' ...
			 'ros.msggen.manipulation_msgs.Object' ...
			 '' ...
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.manipulation_msgs.AddRemoveObjectsRequest.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.manipulation_msgs.AddRemoveObjectsRequest;
            obj.reload(strObj);
        end
    end
end
