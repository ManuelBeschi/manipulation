...
// Service Client for manipulation_msgs/AddObjectsRequest
...
namespace AddObjects_Request {
MANIPULATION_MSGS_EXPORT void copy_from_arr(manipulation_msgs::AddObjects::Request& request,
...
namespace manipulation_msgs {
namespace matlabhelper {
namespace AddObjects_Response {
MANIPULATION_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const manipulation_msgs::AddObjects::Response& response);
} // namespace AddObjects_Response
} // namespace matlabhelper
} // namespace manipulation_msgs
class MANIPULATION_MSGS_EXPORT manipulation_msgs_srv_AddObjects_client
    ...
    std::map<int64_t, manipulation_msgs::AddObjects::Request> mRequestPool;
    manipulation_msgs::AddObjects::Request mNextRequest;
  public:
    manipulation_msgs_srv_AddObjects_client()
        : MATLABSvcClientInterface()
        , mNextRequest() {
    }
    virtual ~manipulation_msgs_srv_AddObjects_client() {
    }
    virtual intptr_t createSvcClient(const std::string& srv_name,
        ...
        mClient = std::make_shared<ros::ServiceClient>(
            theNode->serviceClient<manipulation_msgs::AddObjects>(srv_name));
    ...
    virtual bool send_request(void* sd,
        ...
        manipulation_msgs::AddObjects svc;
        ...
        if (ret) {
            ...
            auto outArray =
                manipulation_msgs::matlabhelper::AddObjects_Response::get_arr(mFactory, svc.response);
            if (sd != NULL) {
    ...
    virtual bool addRequestToPool(matlab::data::Array arr) {
        manipulation_msgs::AddObjects::Request req;
        manipulation_msgs::matlabhelper::AddObjects_Request::copy_from_arr(req, arr);
        mRequestPool.insert(
                {manipulation_msgs::matlabhelper::AddObjects_Request::get_requestId_from_arr(arr), 
                         req});
        return true;
    }
...
CLASS_LOADER_REGISTER_CLASS(manipulation_msgs_srv_AddObjects_client, MATLABSvcClientInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
