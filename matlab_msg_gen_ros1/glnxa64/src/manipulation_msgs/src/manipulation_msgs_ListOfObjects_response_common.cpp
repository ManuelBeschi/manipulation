...
// Common copy functions of server for manipulation_msgs/ListOfObjectsResponse
...
namespace ListOfObjects_Response {
  //----------------------------------------------------------------------------
  MANIPULATION_MSGS_EXPORT void copy_from_arr(manipulation_msgs::ListOfObjects::Response& msg, const matlab::data::StructArray arr) {
    try {
        //type
  ...
  //----------------------------------------------------------------------------
  MANIPULATION_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const manipulation_msgs::ListOfObjects::Response& msg) {
