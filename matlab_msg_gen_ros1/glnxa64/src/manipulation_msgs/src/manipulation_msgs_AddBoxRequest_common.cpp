...
namespace AddBoxRequest {
  ...
  MDArray_T get_arr_geometry_msgs_Pose(MDFactory_T& factory, const manipulation_msgs::AddBoxRequest::_box_pose_type& val);
  ...
  //----------------------------------------------------------------------------
  MANIPULATION_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<manipulation_msgs::AddBoxRequest>& msg, const matlab::data::StructArray arr) {
    try {
        //inbound_box_name
  ...
  //----------------------------------------------------------------------------
  MANIPULATION_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const manipulation_msgs::AddBoxRequest>& msg) {
