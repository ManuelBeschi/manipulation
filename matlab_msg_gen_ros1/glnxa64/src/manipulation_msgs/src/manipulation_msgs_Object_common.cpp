...
// Common copy functions for manipulation_msgs/Object
...
namespace Object {
  ...
  //----------------------------------------------------------------------------
  MANIPULATION_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<manipulation_msgs::Object>& msg, const matlab::data::StructArray arr) {
    try {
        //grasping_poses
  ...
  //----------------------------------------------------------------------------
  MANIPULATION_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const manipulation_msgs::Object>& msg) {
    auto outArray = factory.createStructArray({1,1},{"grasping_poses","type","id","pose"});
    // grasping_poses
    outArray[0]["grasping_poses"] = get_arr_manipulation_msgs_Grasp_var_arr(factory, msg->grasping_poses);
    // type
