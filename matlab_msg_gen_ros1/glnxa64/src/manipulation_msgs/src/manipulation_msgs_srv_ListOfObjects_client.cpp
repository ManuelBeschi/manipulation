...
// Service Client for manipulation_msgs/ListOfObjectsRequest
...
MANIPULATION_MSGS_EXPORT void copy_from_arr(manipulation_msgs::ListOfObjects::Request& request,
...
MANIPULATION_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const manipulation_msgs::ListOfObjects::Response& response);
} // namespace ListOfObjects_Response
} // namespace matlabhelper
} // namespace manipulation_msgs
class MANIPULATION_MSGS_EXPORT manipulation_msgs_srv_ListOfObjects_client
    ...
    std::map<int64_t, manipulation_msgs::ListOfObjects::Request> mRequestPool;
    manipulation_msgs::ListOfObjects::Request mNextRequest;
  public:
    manipulation_msgs_srv_ListOfObjects_client()
        : MATLABSvcClientInterface()
        , mNextRequest() {
    }
    virtual ~manipulation_msgs_srv_ListOfObjects_client() {
    }
    virtual intptr_t createSvcClient(const std::string& srv_name,
        ...
        mClient = std::make_shared<ros::ServiceClient>(
            theNode->serviceClient<manipulation_msgs::ListOfObjects>(srv_name));
    ...
    virtual bool send_request(void* sd,
        ...
        manipulation_msgs::ListOfObjects svc;
        ...
        if (ret) {
            ...
            auto outArray =
                manipulation_msgs::matlabhelper::ListOfObjects_Response::get_arr(mFactory, svc.response);
            if (sd != NULL) {
    ...
    virtual bool addRequestToPool(matlab::data::Array arr) {
        manipulation_msgs::ListOfObjects::Request req;
        manipulation_msgs::matlabhelper::ListOfObjects_Request::copy_from_arr(req, arr);
        mRequestPool.insert(
                {manipulation_msgs::matlabhelper::ListOfObjects_Request::get_requestId_from_arr(arr), 
                         req});
        return true;
    }
...
CLASS_LOADER_REGISTER_CLASS(manipulation_msgs_srv_ListOfObjects_client, MATLABSvcClientInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
