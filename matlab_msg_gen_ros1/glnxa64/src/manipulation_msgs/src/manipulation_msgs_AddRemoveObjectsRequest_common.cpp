...
// Common copy functions for manipulation_msgs/AddRemoveObjectsRequest
...
namespace AddRemoveObjectsRequest {
  ...
  MDArray_T get_arr_manipulation_msgs_Object_var_arr(MDFactory_T& factory, const manipulation_msgs::AddRemoveObjectsRequest::_add_objects_type& val);
  ...
  //----------------------------------------------------------------------------
  MANIPULATION_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<manipulation_msgs::AddRemoveObjectsRequest>& msg, const matlab::data::StructArray arr) {
    try {
        //inbound_box_name
    ...
    try {
        ...
        for (auto _remove_objectsarr : remove_objects_arr) {
        	manipulation_msgs::Object _val;
        	copy_from_arr_manipulation_msgs_Object_var_arr(_val,_remove_objectsarr);
  ...
  //----------------------------------------------------------------------------
  MANIPULATION_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const manipulation_msgs::AddRemoveObjectsRequest>& msg) {
    ...
    // remove_objects
    outArray[0]["remove_objects"] = get_arr_manipulation_msgs_Object_var_arr(factory, msg->remove_objects);
