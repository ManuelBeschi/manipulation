...
// Service Client for manipulation_msgs/AddRemoveObjectsRequest
...
MANIPULATION_MSGS_EXPORT void copy_from_arr(manipulation_msgs::AddRemoveObjects::Request& request,
...
MANIPULATION_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const manipulation_msgs::AddRemoveObjects::Response& response);
} // namespace AddRemoveObjects_Response
} // namespace matlabhelper
} // namespace manipulation_msgs
class MANIPULATION_MSGS_EXPORT manipulation_msgs_srv_AddRemoveObjects_client
    ...
    std::map<int64_t, manipulation_msgs::AddRemoveObjects::Request> mRequestPool;
    manipulation_msgs::AddRemoveObjects::Request mNextRequest;
  public:
    manipulation_msgs_srv_AddRemoveObjects_client()
        : MATLABSvcClientInterface()
        , mNextRequest() {
    }
    virtual ~manipulation_msgs_srv_AddRemoveObjects_client() {
    }
    virtual intptr_t createSvcClient(const std::string& srv_name,
        ...
        mClient = std::make_shared<ros::ServiceClient>(
            theNode->serviceClient<manipulation_msgs::AddRemoveObjects>(srv_name));
    ...
    virtual bool send_request(void* sd,
        ...
        manipulation_msgs::AddRemoveObjects svc;
        ...
        if (ret) {
            ...
            auto outArray =
                manipulation_msgs::matlabhelper::AddRemoveObjects_Response::get_arr(mFactory, svc.response);
            if (sd != NULL) {
    ...
    virtual bool addRequestToPool(matlab::data::Array arr) {
        manipulation_msgs::AddRemoveObjects::Request req;
        manipulation_msgs::matlabhelper::AddRemoveObjects_Request::copy_from_arr(req, arr);
        mRequestPool.insert(
                {manipulation_msgs::matlabhelper::AddRemoveObjects_Request::get_requestId_from_arr(arr), 
                         req});
        return true;
    }
...
CLASS_LOADER_REGISTER_CLASS(manipulation_msgs_srv_AddRemoveObjects_client, MATLABSvcClientInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
