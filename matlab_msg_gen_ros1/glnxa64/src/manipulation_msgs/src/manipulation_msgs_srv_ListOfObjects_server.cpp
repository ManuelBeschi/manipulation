...
// Service Server for manipulation_msgs/ListOfObjectsResponse
...
MANIPULATION_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const manipulation_msgs::ListOfObjects::Request& request);
} // namespace ListOfObjects_Request
} // namespace matlabhelper
} // namespace manipulation_msgs
namespace manipulation_msgs {
...
MANIPULATION_MSGS_EXPORT void copy_from_arr(manipulation_msgs::ListOfObjects::Response& response,
                                          const matlab::data::StructArray arr);
} // namespace ListOfObjects_Response
} // namespace matlabhelper
} // namespace manipulation_msgs
class MANIPULATION_MSGS_EXPORT manipulation_msgs_srv_ListOfObjects_server
    : public MATLABSvcServerInterface {
    manipulation_msgs::ListOfObjects::Response mResponse;
    void* mSd;
    SendDataToMATLABFunc_T mSendDataToMATLABFunc;
    intptr_t mHSvcServer;
    bool callback(manipulation_msgs::ListOfObjects::Request& req,
                  manipulation_msgs::ListOfObjects::Response& res) {
        auto outArray = manipulation_msgs::matlabhelper::ListOfObjects_Request::get_arr(mFactory, req);
        if (mSd != NULL) {
  ...
  public:
    manipulation_msgs_srv_ListOfObjects_server()
    ...
    virtual ~manipulation_msgs_srv_ListOfObjects_server() {
    }
    virtual bool setResponseFromMatlab(matlab::data::Array arr) {
        manipulation_msgs::matlabhelper::ListOfObjects_Response::copy_from_arr(mResponse, arr);
        return true;
    }
    virtual intptr_t createSvcServer(const std::string& svc_name,
        ...
        mSvc = std::make_shared<ros::ServiceServer>(theNode->advertiseService(
            svc_name, &manipulation_msgs_srv_ListOfObjects_server::callback, this));
...
CLASS_LOADER_REGISTER_CLASS(manipulation_msgs_srv_ListOfObjects_server, MATLABSvcServerInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
