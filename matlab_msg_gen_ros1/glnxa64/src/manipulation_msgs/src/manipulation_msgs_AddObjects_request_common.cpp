...
namespace AddObjects_Request {
  ...
  MDArray_T get_arr_manipulation_msgs_Object_var_arr(MDFactory_T& factory, const manipulation_msgs::AddObjects::Request::_add_objects_type& val);
  ...
  //----------------------------------------------------------------------------
  MANIPULATION_MSGS_EXPORT void copy_from_arr(manipulation_msgs::AddObjects::Request& msg, const matlab::data::StructArray arr) {
    try {
        //inbound_box_name
  ...
  //----------------------------------------------------------------------------
  MANIPULATION_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const manipulation_msgs::AddObjects::Request& msg) {
