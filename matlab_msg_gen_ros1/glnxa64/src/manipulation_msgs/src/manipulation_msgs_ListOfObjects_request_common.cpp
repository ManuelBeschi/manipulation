...
namespace ListOfObjects_Request {
  //----------------------------------------------------------------------------
  MANIPULATION_MSGS_EXPORT void copy_from_arr(manipulation_msgs::ListOfObjects::Request& msg, const matlab::data::StructArray arr) {
  }
  ...
  //----------------------------------------------------------------------------
  MANIPULATION_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const manipulation_msgs::ListOfObjects::Request& msg) {
