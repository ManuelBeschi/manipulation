...
// Service Server for manipulation_msgs/RemoveLocationsResponse
...
MANIPULATION_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const manipulation_msgs::RemoveLocations::Request& request);
} // namespace RemoveLocations_Request
} // namespace matlabhelper
} // namespace manipulation_msgs
namespace manipulation_msgs {
...
MANIPULATION_MSGS_EXPORT void copy_from_arr(manipulation_msgs::RemoveLocations::Response& response,
                                          const matlab::data::StructArray arr);
} // namespace RemoveLocations_Response
} // namespace matlabhelper
} // namespace manipulation_msgs
class MANIPULATION_MSGS_EXPORT manipulation_msgs_srv_RemoveLocations_server
    : public MATLABSvcServerInterface {
    manipulation_msgs::RemoveLocations::Response mResponse;
    void* mSd;
    SendDataToMATLABFunc_T mSendDataToMATLABFunc;
    intptr_t mHSvcServer;
    bool callback(manipulation_msgs::RemoveLocations::Request& req,
                  manipulation_msgs::RemoveLocations::Response& res) {
        auto outArray = manipulation_msgs::matlabhelper::RemoveLocations_Request::get_arr(mFactory, req);
        if (mSd != NULL) {
  ...
  public:
    manipulation_msgs_srv_RemoveLocations_server()
    ...
    virtual ~manipulation_msgs_srv_RemoveLocations_server() {
    }
    virtual bool setResponseFromMatlab(matlab::data::Array arr) {
        manipulation_msgs::matlabhelper::RemoveLocations_Response::copy_from_arr(mResponse, arr);
        return true;
    }
    virtual intptr_t createSvcServer(const std::string& svc_name,
        ...
        mSvc = std::make_shared<ros::ServiceServer>(theNode->advertiseService(
            svc_name, &manipulation_msgs_srv_RemoveLocations_server::callback, this));
...
CLASS_LOADER_REGISTER_CLASS(manipulation_msgs_srv_RemoveLocations_server, MATLABSvcServerInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
