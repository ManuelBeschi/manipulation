...
// Service Client for manipulation_msgs/AddLocationsRequest
...
namespace AddLocations_Request {
MANIPULATION_MSGS_EXPORT void copy_from_arr(manipulation_msgs::AddLocations::Request& request,
...
namespace manipulation_msgs {
namespace matlabhelper {
namespace AddLocations_Response {
MANIPULATION_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const manipulation_msgs::AddLocations::Response& response);
} // namespace AddLocations_Response
} // namespace matlabhelper
} // namespace manipulation_msgs
class MANIPULATION_MSGS_EXPORT manipulation_msgs_srv_AddLocations_client
    ...
    std::map<int64_t, manipulation_msgs::AddLocations::Request> mRequestPool;
    manipulation_msgs::AddLocations::Request mNextRequest;
  public:
    manipulation_msgs_srv_AddLocations_client()
        : MATLABSvcClientInterface()
        , mNextRequest() {
    }
    virtual ~manipulation_msgs_srv_AddLocations_client() {
    }
    virtual intptr_t createSvcClient(const std::string& srv_name,
        ...
        mClient = std::make_shared<ros::ServiceClient>(
            theNode->serviceClient<manipulation_msgs::AddLocations>(srv_name));
    ...
    virtual bool send_request(void* sd,
        ...
        manipulation_msgs::AddLocations svc;
        ...
        if (ret) {
            ...
            auto outArray =
                manipulation_msgs::matlabhelper::AddLocations_Response::get_arr(mFactory, svc.response);
            if (sd != NULL) {
    ...
    virtual bool addRequestToPool(matlab::data::Array arr) {
        ...
        manipulation_msgs::matlabhelper::AddLocations_Request::copy_from_arr(req, arr);
        mRequestPool.insert(
                {manipulation_msgs::matlabhelper::AddLocations_Request::get_requestId_from_arr(arr), 
                         req});
        return true;
    }
...
CLASS_LOADER_REGISTER_CLASS(manipulation_msgs_srv_AddLocations_client, MATLABSvcClientInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
