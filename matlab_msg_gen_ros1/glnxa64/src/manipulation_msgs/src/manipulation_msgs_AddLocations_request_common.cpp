...
namespace AddLocations_Request {
  ...
  MDArray_T get_arr_manipulation_msgs_Location_var_arr(MDFactory_T& factory, const manipulation_msgs::AddLocations::Request::_locations_type& val);
  ...
  //----------------------------------------------------------------------------
  MANIPULATION_MSGS_EXPORT void copy_from_arr(manipulation_msgs::AddLocations::Request& msg, const matlab::data::StructArray arr) {
    try {
        //locations
  ...
  //----------------------------------------------------------------------------
  MANIPULATION_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const manipulation_msgs::AddLocations::Request& msg) {
