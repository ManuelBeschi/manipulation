...
namespace AddRemoveObjectsRequest {
  ...
  MDArray_T get_arr_pickplace_msgs_Object_var_arr(MDFactory_T& factory, const pickplace_msgs::AddRemoveObjectsRequest::_add_objects_type& val);
  ...
  //----------------------------------------------------------------------------
  PICKPLACE_MSGS_EXPORT void copy_from_arr(boost::shared_ptr<pickplace_msgs::AddRemoveObjectsRequest>& msg, const matlab::data::StructArray arr) {
    try {
        //inbound_box_name
  ...
  //----------------------------------------------------------------------------
  PICKPLACE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const boost::shared_ptr<const pickplace_msgs::AddRemoveObjectsRequest>& msg) {
