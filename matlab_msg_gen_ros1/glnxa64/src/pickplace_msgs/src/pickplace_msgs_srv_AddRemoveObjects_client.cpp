...
// Service Client for pickplace_msgs/AddRemoveObjectsRequest
...
PICKPLACE_MSGS_EXPORT void copy_from_arr(pickplace_msgs::AddRemoveObjects::Request& request,
...
PICKPLACE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const pickplace_msgs::AddRemoveObjects::Response& response);
} // namespace AddRemoveObjects_Response
} // namespace matlabhelper
} // namespace pickplace_msgs
class PICKPLACE_MSGS_EXPORT pickplace_msgs_srv_AddRemoveObjects_client
    ...
    std::map<int64_t, pickplace_msgs::AddRemoveObjects::Request> mRequestPool;
    pickplace_msgs::AddRemoveObjects::Request mNextRequest;
  public:
    pickplace_msgs_srv_AddRemoveObjects_client()
        : MATLABSvcClientInterface()
        , mNextRequest() {
    }
    virtual ~pickplace_msgs_srv_AddRemoveObjects_client() {
    }
    virtual intptr_t createSvcClient(const std::string& srv_name,
        ...
        mClient = std::make_shared<ros::ServiceClient>(
            theNode->serviceClient<pickplace_msgs::AddRemoveObjects>(srv_name));
    ...
    virtual bool send_request(void* sd,
        ...
        pickplace_msgs::AddRemoveObjects svc;
        ...
        if (ret) {
            ...
            auto outArray =
                pickplace_msgs::matlabhelper::AddRemoveObjects_Response::get_arr(mFactory, svc.response);
            if (sd != NULL) {
    ...
    virtual bool addRequestToPool(matlab::data::Array arr) {
        pickplace_msgs::AddRemoveObjects::Request req;
        pickplace_msgs::matlabhelper::AddRemoveObjects_Request::copy_from_arr(req, arr);
        mRequestPool.insert(
                {pickplace_msgs::matlabhelper::AddRemoveObjects_Request::get_requestId_from_arr(arr), 
                         req});
        return true;
    }
...
CLASS_LOADER_REGISTER_CLASS(pickplace_msgs_srv_AddRemoveObjects_client, MATLABSvcClientInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
