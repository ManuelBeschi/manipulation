...
// Common copy functions of server for pickplace_msgs/ListOfObjectsResponse
...
namespace ListOfObjects_Response {
  ...
  MDArray_T get_arr_pickplace_msgs_PickBox_var_arr(MDFactory_T& factory, const pickplace_msgs::ListOfObjects::Response::_inbound_boxes_type& val);
  ...
  //----------------------------------------------------------------------------
  PICKPLACE_MSGS_EXPORT void copy_from_arr(pickplace_msgs::ListOfObjects::Response& msg, const matlab::data::StructArray arr) {
    try {
        //inbound_boxes
  ...
  //----------------------------------------------------------------------------
  PICKPLACE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory, const pickplace_msgs::ListOfObjects::Response& msg) {
