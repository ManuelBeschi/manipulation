...
// Service Client for pickplace_msgs/ListOfObjectsRequest
...
#include "pickplace_msgs/ListOfObjects.h"
#include <thread>
namespace pickplace_msgs {
namespace matlabhelper {
namespace ListOfObjects_Request {
PICKPLACE_MSGS_EXPORT void copy_from_arr(pickplace_msgs::ListOfObjects::Request& request,
...
namespace pickplace_msgs {
namespace matlabhelper {
namespace ListOfObjects_Response {
PICKPLACE_MSGS_EXPORT MDArray_T get_arr(MDFactory_T& factory,
                                         const pickplace_msgs::ListOfObjects::Response& response);
} // namespace ListOfObjects_Response
} // namespace matlabhelper
} // namespace pickplace_msgs
class PICKPLACE_MSGS_EXPORT pickplace_msgs_srv_ListOfObjects_client
    ...
    std::map<int64_t, pickplace_msgs::ListOfObjects::Request> mRequestPool;
    pickplace_msgs::ListOfObjects::Request mNextRequest;
  public:
    pickplace_msgs_srv_ListOfObjects_client()
        : MATLABSvcClientInterface()
        , mNextRequest() {
    }
    virtual ~pickplace_msgs_srv_ListOfObjects_client() {
    }
    virtual intptr_t createSvcClient(const std::string& srv_name,
        ...
        mClient = std::make_shared<ros::ServiceClient>(
            theNode->serviceClient<pickplace_msgs::ListOfObjects>(srv_name));
    ...
    virtual bool send_request(void* sd,
        ...
        pickplace_msgs::ListOfObjects svc;
        ...
        if (ret) {
            ...
            auto outArray =
                pickplace_msgs::matlabhelper::ListOfObjects_Response::get_arr(mFactory, svc.response);
            if (sd != NULL) {
    ...
    virtual bool addRequestToPool(matlab::data::Array arr) {
        pickplace_msgs::ListOfObjects::Request req;
        pickplace_msgs::matlabhelper::ListOfObjects_Request::copy_from_arr(req, arr);
        mRequestPool.insert(
                {pickplace_msgs::matlabhelper::ListOfObjects_Request::get_requestId_from_arr(arr), 
                         req});
        return true;
    }
...
CLASS_LOADER_REGISTER_CLASS(pickplace_msgs_srv_ListOfObjects_client, MATLABSvcClientInterface)
#ifdef _MSC_VER
#pragma warning(pop)
#else
